...
toggleEye1.addEventListener("click", () => {
  ...
  toggleEye1.classList.toggle("hidden", isHidden);
});

submitBtn.addEventListener("click", () => {
  if (passwordInput1.value.trim() === "") {
    passwordInput1.classList.add("error");
    toggleEye1.classList.add("error-icon");
  } else {
    passwordInput1.classList.remove("error");
    toggleEye1.classList.remove("error-icon");
  }
});
// ------------------------
...
const passwordToggles = [
  ...
  {
    id: 3,
    hide: "resetform-password-hide-password",
    show: "resetfrom-password-error-hide",
    input: "resetform-password-input",
  },
  {
    id: 4,
    hide: "reset-password-hide-password",
    show: "reset-password-error-hide",
    input: "reset-password-input",
  },
  {
    id: 5,
    hide: "registrationForm-password-hide-password",
    show: "registrationForm-password-error-hide",
    input: "registration-password-input",
  },
  {
    id: 6,
    hide: "registration-password-hide-password",
    show: "registration-password-error-hide",
...
function passwordToggle(id) {
  ...
  if (hideIcon && showIcon && passwordField) {
    hideIcon.addEventListener("click", () =>
      togglePassword(passwordField, hideIcon, showIcon)
    );
...
function auzorithationErrors(email, password) {
  ...
  const PassowrdErrorMessage = document.getElementById(
...
const forgetPasswordEmailInput = document.getElementById(
  "forget-password-email-input"
);
...
function forgetPasswordErrors(email) {
  const forgetPasswordEmailLabel = document.getElementById(
...
const resetFormPasswordInput = document.getElementById(
...
const registrationFormEmailInput = document.getElementById(
  "registration-email-input"
);
const registrationFormPasswordInput = document.getElementById(
  "registration-password-input"
);
const registrationFormRepeatPasswordInput = document.getElementById(
...
registrationForm.addEventListener("submit", (e) => {
  ...
  registrationErrors(
    nameInput,
    surnameInput,
    registrationFormEmailInput,
    registrationFormPasswordInput,
    registrationFormRepeatPasswordInput
  );
});
...
function registrationErrors(name, surname, email, password, repeatPassword) {
  ...
  const registrationFormEmailLabel = document.getElementById(
    "registration-email-label"
  );
  const registrationFormPasswordLabel = document.getElementById(
    "registration-password-label"
  );
  const registrationFormRepeatPasswordLabel = document.getElementById(
    "repeat-password-label"
  );

  const registrationFormHideIcon = document.getElementById(
    "registrationForm-password-hide-password"
  );
  const registrationFormErrorIcon = document.getElementById(
    "registrationForm-password-error-hide"
  );
  const registrationHideIcon = document.getElementById(
    "registration-password-hide-password"
  );
  const registrationErrorIcon = document.getElementById(
    "registration-password-error-hide"
  );

  const nameErrorMessage = document.getElementById(
    "register-form-name-error-message"
  );
  const surnameErrorMessage = document.getElementById(
    "register-form-surname-error-message"
  );
  const emailErrorMessage = document.getElementById(
    "register-form-email-error-message"
  );
  const passwordErrorMessage = document.getElementById(
    "register-form-password-error-message"
  );
  const repeatPasswordErrorMessage = document.getElementById(
    "register-form-reset-password-error-message"
  );
  let passwordErrors = [];
  ...
  if (password.value.trim() === "" || password.value === null) {
    ...
    showResetPasswordErrors(
      ...
      passwordErrorMessage,
      "პაროლი",
      registrationFormHideIcon,
      registrationFormErrorIcon
    );
  } else if (password.value.length < 8) {
    passwordErrors.push("პაროლი მინიმუმ უნდა შეიცავდეს 8 სიმბოლოს");
    showResetPasswordErrors(
  ...
  if (repeatPassword.value.trim() === "" || repeatPassword.value === null) {
    ...
    showResetPasswordErrors(
      repeatPassword,
      registrationFormRepeatPasswordLabel,
      repeatPasswordErrorMessage,
      "გაიმეორეთ პაროლი",
      registrationHideIcon,
...
function clearAllErrors() {
  ...
  document
    ...
    .forEach((label) => label.classList.remove("error-text"));
  document
    .querySelectorAll(".error-message")
    .forEach((error) => error.classList.remove("block"));
  document
    .querySelectorAll(".show")
    .forEach((icon) => icon.classList.remove("block"));
